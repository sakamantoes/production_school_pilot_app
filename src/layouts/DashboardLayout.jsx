...
const getMenuItems = (role, dashboardPath) => {
  ...
  if (role === "school_admin") return [
    ...
    { text: "Attendance $ Report",           icon: ClipboardCheck,path: "/school-admin/attendance-report",         group: "Academics" },
    ...
    { text: "Analysis",              icon: BarChart3,     path: "/school-admin/reports",            group: "Reports" },
    { text: "Notification Management",        icon: Announcement,  path: "/school-admin/announcements-Management",      group: "Comms" },
    { text: "Announcement Management",  icon: Mail,          path: "/school-admin/notifications-Management",group: "Comms" },
  ];
