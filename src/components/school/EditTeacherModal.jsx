// components/school/EditTeacherModal.jsx
import React, { useState } from 'react';
import { teacherAPI } from '../../services/schoolApi';

const EditTeacherModal = ({ teacher, onSuccess, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await teacherAPI.updateTeacher(teacher.id, formData);
